            ...
            <div class="p-8"> @if(!$batch || ($batch && $batch->total_files === 0))
                <form id="xmlForm" method="POST" action="{{ route('upload-xml') }}" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label class="block text-xs font-bold text-gris-carbon uppercase mb-2">Correo
                                Institucional</label>
                            <div class="relative">
                                <div
                    ...
                    <div class="flex justify-end pt-4 border-t border-gray-100">
                        <button type="submit"
                            class="bg-dorado text-white px-6 py-3 rounded-lg text-xs font-bold uppercase tracking-widest hover:bg-dorado/90 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center gap-2">
