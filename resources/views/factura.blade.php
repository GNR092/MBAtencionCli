...
<div class="w-full flex flex-col min-h-screen">
    ...
    <header class="mb-20 px-2">
        <div class="flex items-baseline gap-4">
            <span class="text-dorado text-sm font-serif italic">01</span>
            <h1 class="text-white text-7xl md:text-9xl font-extralight tracking-[-0.02em] leading-none">
                Factura<span class="font-light">ción</span><span class="text-dorado animate-pulse">_</span>
            </h1>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 px-2 mb-20">
        ...
        <div class="lg:col-span-8 bg-white rounded-2xl shadow-xl border border-carbon overflow-hidden">
            ...
            <div class="p-8"> @if(!$batch || ($batch && $batch->total_files === 0))
                <form id="xmlForm" method="POST" action="{{ route('upload-xml') }}" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label class="block text-xs font-bold text-gris-carbon uppercase mb-2">Correo</label>
                            <div class="relative">
                                <div
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gris-carbon uppercase mb-2">Asignación de
                                Proyecto</label>
                            <div class="relative">
                    ...
                    <div class="relative group">
                        <label class="block text-xs font-bold text-gris-carbon uppercase mb-2">Archivos XML</label>
                        <div
                            class="w-full h-48 rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 flex flex-col justify-center items-center group-hover:border-dorado group-hover:bg-dorado/5 transition-all duration-300 cursor-pointer overflow-hidden relative">
                            ...
                            <p class="text-sm font-bold text-gris-carbon uppercase tracking-wider mb-1 relative z-10">
                    ...
                    <div class="flex justify-end pt-4 border-t border-gray-100">
                        <button type="submit"
                            class="bg-dorado text-white px-6 py-3 h-10 rounded-lg text-xs font-bold uppercase tracking-widest hover:bg-dorado/90 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center gap-2">
        ...
        <div class="lg:col-span-4 flex flex-col h-full">
            <div
                class="bg-gris-carbon rounded-2xl shadow-xl border border-carbon p-8 flex flex-col h-full relative overflow-hidden">

                <div class="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-dorado rounded-full opacity-10 blur-3xl">
                </div>

                <h3
                    class="text-dorado text-sm tracking-[0.2em] uppercase font-bold mb-8 border-b border-dorado/30 pb-4">
                    Guía de Usuario
                </h3>
                ...
                <ul class="space-y-8 relative z-10">
                    <li class="flex gap-4 items-start group">
                        <span
                            class="text-dorado font-serif italic text-2xl leading-none opacity-50 group-hover:opacity-100 transition">01</span>
                        <p
                    ...
                    <li class="flex gap-4 items-start group">
                        <span
                            class="text-dorado font-serif italic text-2xl leading-none opacity-50 group-hover:opacity-100 transition">02</span>
                        <p
                            class="text-gray-300 text-xs leading-relaxed tracking-wide uppercase group-hover:text-white transition">
    ...
    <footer class="grid grid-cols-1 lg:grid-cols-12 gap-20 px-2 py-20 border-t border-white/5">
        <div class="lg:col-span-4">
            <h4 class="text-dorado text-[10px] tracking-[0.4em] uppercase mb-6">Mesa de Ayuda</h4>
