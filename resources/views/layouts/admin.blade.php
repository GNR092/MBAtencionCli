...
<head>
    ...
    <style>
        ...
        .watermark-logo {
            ...
            top: 50%;
            left: 50%;
            transform: translate(-50%, -50%) scale(0.7); /* Escala pequeña (igual al final de la animación) */
            width: 300px;
            opacity: 0.3; /* Opacidad baja */
            pointer-events: none; /* No bloquea clicks */
            z-index: -5; /* Detrás del contenido, delante del fondo */
        }
