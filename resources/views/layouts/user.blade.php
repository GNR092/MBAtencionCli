                ...
                <div id="sidebar-content" class="flex flex-col h-full">
                    <div class="dropdown">
                        ...
                        <div class="hidden bg-gray-700 rounded-md accordion-content">
                            <a href="/facturacion" class="block py-2 pl-8 font-medium text-gray-200 no-underline transition-all duration-200 ease-in-out hover:bg-gray-700 hover:text-white hover:border-l-4 hover:border-yellow-400">Facturación</a>
                            <a href="/cuentas-por-cobrar" class="block py-2 pl-8 font-medium text-gray-200 no-underline transition-all duration-200 ease-in-out hover:bg-gray-700 hover:text-white hover:border-l-4 hover:border-yellow-400">Cuentas por cobrar</a>
                            <a href="/estados-de-cuenta" class="block py-2 pl-8 font-medium text-gray-200 no-underline transition-all duration-200 ease-in-out hover:bg-gray-700 hover:text-white hover:border-l-4 hover:border-yellow-400">Estados de cuenta</a>
                            <a href="/contratos" class="block py-2 pl-8 font-medium text-gray-200 no-underline transition-all duration-200 ease-in-out hover:bg-gray-700 hover:text-white hover:border-l-4 hover:border-yellow-400">Contratos</a>
                            <a href="/notificaciones" class="block py-2 pl-8 font-medium text-gray-200 no-underline transition-all duration-200 ease-in-out hover:bg-gray-700 hover:text-white hover:border-l-4 hover:border-yellow-400">Notificaciones</a>
                        </div>
                    </div>
