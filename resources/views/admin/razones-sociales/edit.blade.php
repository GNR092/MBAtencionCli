...
<div class="w-full p-4 md:p-6 animate-fadeInUp">
    ...
    <form action="{{ route('razones-sociales.update', $razonSocial->id_razon_social) }}" method="POST" class="p-8 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="nombre_razon_social" value="{{ old('nombre_razon_social', $razonSocial->nombre_razon_social) }}" required
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="rfc" value="{{ old('rfc', $razonSocial->rfc) }}" required maxlength="13"
            ...
            <div>
                ...
                <input type="text" name="telefono" value="{{ old('telefono', $razonSocial->telefono) }}" maxlength="20"
                    class="w-full bg-white/5 border border-[#d8c495]/30 rounded-lg px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#d8c495] focus:ring-1 focus:ring-[#d8c495]/30 transition-colors">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="email" name="email" value="{{ old('email', $razonSocial->email) }}"
                    class="w-full bg-white/5 border border-[#d8c495]/30 rounded-lg px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#d8c495] focus:ring-1 focus:ring-[#d8c495]/30 transition-colors">
            </div>
            ...
            <div>
                ...
                <input type="text" name="direccion" value="{{ old('direccion', $razonSocial->direccion) }}"
                    class="w-full bg-white/5 border border-[#d8c495]/30 rounded-lg px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#d8c495] focus:ring-1 focus:ring-[#d8c495]/30 transition-colors">
            </div>
        </div>
