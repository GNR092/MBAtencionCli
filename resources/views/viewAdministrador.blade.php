...
@section('content')
    <div class="w-full p-4 md:p-6 animate-fadeInUp">
        ...
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-gray-200">
                <form method="GET" action="{{ route('viewAdministrador') }}" class="flex flex-col lg:flex-row gap-4 items-end lg:items-center">
                    @csrf
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-1 gap-4 w-full">
                        ...
                        <div class="flex flex-col w-full sm:w-44">
                            ...
                            <select name="categoria" id="categoria" class="w-full p-2.5 rounded-xl border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-[#d8c495] outline-none">
                        ...
                        <div class="flex items-center gap-2 mt-auto">
                            <button type="submit" class="flex-1 lg:flex-none bg-[#3c3c3c] text-[#d8c495] px-6 py-2.5 rounded-xl font-bold hover:bg-black transition shadow-md">
                                BUSCAR
                            </button>
                            <a href="{{ route('viewAdministrador.limpiar') }}" class="flex-1 lg:flex-none bg-gray-200 text-gray-700 px-6 py-2.5 rounded-xl font-bold hover:bg-gray-300 transition text-center">
                                LIMPIAR
                            </a>
                        </div>
                    </div>

                    <button type="button" onClick="openModalDescarga()" class="w-full lg:w-auto bg-[#d8c495] text-[#3c3c3c] px-8 py-2.5 rounded-xl font-bold hover:bg-[#c9a143] transition shadow-md">
                        DESCARGAR
                    </button>
                </form>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="w-full md:w-auto">
                    <button type="button" class="bg-[#3c3c3c] text-[#d8c495] px-8 py-3 rounded-xl font-bold hover:bg-black transition shadow-lg w-full md:w-auto" onClick="openModal()">
                        MOSTRAR GRÁFICAS
                    </button>
                </div>
    ...
    <div id="chartsmModal" class="bg-black/60 backdrop-blur-sm fixed inset-0 z-[9999] flex items-center justify-center hidden p-4">
        <div class="bg-white rounded-3xl shadow-2xl p-4 md:p-8 relative w-full max-w-4xl max-h-[90vh] overflow-y-auto custom-scroll">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div class="space-y-2">
                    ...
                    <select id="filtroYear" class="w-full border p-3 rounded-xl outline-none focus:ring-2 focus:ring-[#d8c495]" onchange="cargarGraficaAnual()">
                ...
                <div class="space-y-2">
                    ...
                    <select id="selectProyecto" class="w-full border p-3 rounded-xl outline-none focus:ring-2 focus:ring-[#d8c495]">
            ...
            <div class="sticky bottom-0 bg-white pt-6 mt-6 border-t flex justify-end">
                <button type="button" onclick="closeModal()" class="bg-gray-800 text-white px-8 py-2 rounded-xl font-bold">CERRAR</button>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('viewAdministrador.export') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1">
                        ...
                        <input type="date" name="desde" id="desde" class="w-full p-3 bg-gray-50 border rounded-xl outline-none focus:ring-2 focus:ring-[#d8c495]">
                    </div>
                    <div class="space-y-1">
                        <label class="text-xs font-bold text-gray-500">HASTA</label>
                        <input type="date" name="hasta" id="hasta" class="w-full p-3 bg-gray-50 border rounded-xl outline-none focus:ring-2 focus:ring-[#d8c495]">
                    </div>
                </div>
                <div class="space-y-1">
                    <label class="text-xs font-bold text-gray-500">ESTADO DE PAGO</label>
                    <select name="estado" id="estado" class="w-full p-3 bg-gray-50 border rounded-xl outline-none focus:ring-2 focus:ring-[#d8c495]">
                ...
                <div class="flex flex-col gap-3 pt-4">
                    ...
                    <button type="button" onclick="closeModalDescarga()" class="text-gray-500 font-bold hover:text-black transition">CANCELAR</button>
                </div>
            </form>
        </div>
    </div>
